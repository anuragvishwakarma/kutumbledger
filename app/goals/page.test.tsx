...
describe('GoalsPage', () => {
  ...
  it('should render the goals page header', async () => {
    render(<GoalsPage />);
    
    // Check for loading state initially
    expect(await screen.findByText(/Loading goals.../i)).toBeInTheDocument();
    
    // Since we're mocking the data to return an empty array, we expect to see the "No goals found" message.
    expect(await screen.findByText(/No goals found/i)).toBeInTheDocument();
  });
  ...
  it('should handle error state', async () => {
    ...
    expect(await screen.findByText(/Error loading goals/i)).toBeInTheDocument();
